    ...
    <>
      <Canvas shadows gl={{ alpha: false, antialias: false }} camera={{ fov: 75, position: [0, 0, 60], near: 10, far: 150 }}>
        ...
        <group position={[0, -45, -10]}>
          <Plane color="hotpink" rotation-x={-Math.PI / 2} position-z={2} scale={[200, 200, 0.2]} />
          <Plane color="#e4be00" rotation-x={-Math.PI / 2} position-y={35} position-z={-60} scale={[200, 0.2, 80]} />
          <Plane color="#736fbd" rotation-x={-Math.PI / 2} position={[70, 35, 3.5]} scale={[0.5, 400, 78]} />
          <Plane color="#736fbd" rotation-x={-Math.PI / 2} position={[-100, 35, 3.5]} scale={[0.5, 400, 78]} />
        </group>
        {/* <Dolly/> */}
      </Canvas>
    </>
